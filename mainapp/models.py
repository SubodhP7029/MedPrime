...
class CustomerProfile(models.Model):
    ...
    billingbuilding = models.CharField(max_length=50,null=True,blank=True)
    billingarea= models.CharField(max_length=50,null=True,blank=True)
    billinglandmark = models.CharField(max_length=50,null=True,blank=True)
