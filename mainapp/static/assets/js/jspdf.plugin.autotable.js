...
/***/ (function (module, exports, __webpack_require__) {
            ...
            function printFullRow(row, isLastRow) {
                ...
                if (row.canEntireRowFit(remainingPageSpace)) {
                    ...
                    doc.text("Continued...", 180, 200, null, null, 'right')
                    doc.setFontType('normal');
                    // addfinalAmout(doc, 200) // uncomment this if you want to add subtotal n all to all pages
