            ...
            if (finalAmout == 0) {
                ...
                if (document.getElementById('PONo').value == '') {
                    Swal.fire({
                        position: 'top-end',
                        icon: 'error',
                        title: 'Please Insert Quotation Number',
                        showConfirmButton: false,
                        timer: 2000
                    })
                } else {
                    PONo = document.getElementById('PONo').value
                    doc.text("Esitmate Date:", datePosition[0], datePosition[1], null, null, 'right')
                    ...
                    if (dueDateEntered[0] == '') {
                        ...
                        doc.text("Expiry Date:", datePosition[0], datePosition[1] + 10, null, null, 'right')
                        var dueDateEntered = document.getElementById('datepicker_expiry').value.split("-")
                        if (dueDateEntered[0] == '') {
                            Swal.fire({
                                position: 'top-end',
                                icon: 'error',
