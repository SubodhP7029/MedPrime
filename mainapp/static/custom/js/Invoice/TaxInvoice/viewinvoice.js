...
function ViewPDF(selectedRowData) {
    ...
    $.get("gettaxdetailofstate/", { sqlParam: SelectedState }, function (gsttype) {
        SelectedCustomerUsername = "SELECT billingaddress,billingpincode,billingcity,billingstate,billingcountry,gst,stateid,address, pincode,  city,state,  country,customername FROM public.mainapp_customerprofile WHERE id=" + selectedRowData[1]
