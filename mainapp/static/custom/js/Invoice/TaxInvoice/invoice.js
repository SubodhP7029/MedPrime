...
function getAllCustomerInfo() {
    SelectedCustomerUsername = "SELECT billingaddress,billingpincode,billingcity,billingstate,billingcountry,gst,stateid,address, pincode,  city,state,  country,customername FROM public.mainapp_customerprofile WHERE id=" + document.getElementById('selectedcustomer').value
